...
const plans = [
  {
    ...
    features: [
      ...
      'Logo texto profissional (wordmark)',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Identidade Visual completa (opcional — R$ 490)',
  ...
  },
  {
    ...
    features: [
      ...
      'Marca exclusiva (símbolo personalizado)',
      'Identidade Visual completa inclusa',
      'Domínio .adv.br incluso no 1º ano',
    ],
    maintenance: [
      'Tudo do Profissional',
...
const tableRows = [
  ...
  { feature: 'Logo texto (wordmark)', promo: true, essencial: true, profissional: true, completo: true },
  { feature: 'Marca exclusiva (símbolo)', promo: '+R$ 490', essencial: '+R$ 490', profissional: '+R$ 490', completo: true },
  { feature: 'Identidade Visual completa', promo: '+R$ 890', essencial: '+R$ 890', profissional: '+R$ 490', completo: true },

...
export default function CtaSection() {
  ...
  return (
    <section className="bg-navy py-28 relative overflow-hidden" ref={ref}>
      ...
      >
        <h2 className="font-playfair font-bold text-white text-2xl md:text-3xl leading-tight mb-6 whitespace-nowrap">
          Busca mais segurança para tomar decisões importantes?
        </h2>
        <p className="font-inter text-gray-300 text-lg mb-10 text-center">
